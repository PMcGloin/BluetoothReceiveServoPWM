...
# 1 "BluetoothReceiveServoPWM.c"

# 52 "C:\Program Files (x86)\Microchip\xc8\v2.05\pic\include\pic18f4520.h"
...
# 114
unsigned char Output[7] = {90,90,0,90,90,10, 90};
while(1){
servoRun(Output);
if (RCIF == 1){
UARTReadString(Output, 6);
}
}
}
